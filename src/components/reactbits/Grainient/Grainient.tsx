...
void mainImage(out vec4 o, vec2 C){
  ...
  if(uLightMode>0.5){
    ...
    float coverage=clamp(0.06+chroma*0.7+energy*0.15,0.0,0.65);
    col=mix(vec3(1.0),clamp(hue*0.62+col*0.22,0.0,1.0),coverage);
  }
...
export default function Grainient({
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.warn('Grainient WebGL initialization failed or not supported:', e);
      return;
    }
